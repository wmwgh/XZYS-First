...
- (void)_setupSubviews
{
    ...
    //输入框
    _inputTextView = [[EaseTextView alloc] initWithFrame:CGRectMake(self.horizontalPadding, self.verticalPadding, self.frame.size.width - self.verticalPadding, self.frame.size.height - self.verticalPadding * 2)];
