...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _selectedTextColor = XZYSBlueColor;
        
        _textAlignment = SMVerticalSegmentedControlTextAlignmentCenter;
...
-(void)indexChangeBlock:(IndexChangeBlock)block{

    _indexChangeBlock = block;
}
