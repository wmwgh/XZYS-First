 ...
 *     微调按钮与滑块之间的距离，默认为10
 */
@property (nonatomic ,assign) int xl_buttonToSlider;
/**
 *     头部控制条里的滑块的高度，默认为2
 */
@property (nonatomic ,assign) int xl_sliderHeight;
