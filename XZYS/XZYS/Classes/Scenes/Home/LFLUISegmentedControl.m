...
#pragma mark -----buttonDown 设置下划线颜色
            [buttonDown setBackgroundColor:XZYSBlueColor];
...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    self=[super initWithFrame:CGRectMake(frame.origin.x, frame.origin.y, frame.size.width, 38)];
    self.LFLBackGroundColor = [UIColor whiteColor];
    self.titleColor = [UIColor blackColor];
    self.selectColor = XZYSBlueColor;
    //    整体背景颜色
