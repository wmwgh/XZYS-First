...
- (IBAction)colorAction:(UIButton *)sender {
    ...
    NSLog(@"%@", str);
    //发出通知
    [[NSNotificationCenter defaultCenter] postNotificationName:@"jjBt" object:self userInfo:[NSDictionary dictionaryWithObject:str forKey:@"sid"]];
}
