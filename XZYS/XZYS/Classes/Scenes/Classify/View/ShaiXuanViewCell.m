...
@implementation ShaiXuanViewCell
...
- (IBAction)colorAction:(UIButton *)sender {
    ...
    //发出通知
    [[NSNotificationCenter defaultCenter] postNotificationName:@"zcBt" object:self userInfo:[NSDictionary dictionaryWithObject:str forKey:@"sid"]];
}
